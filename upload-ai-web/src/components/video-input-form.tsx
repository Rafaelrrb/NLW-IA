...
export function VideoInputForm({onVideoUploaded}:VideoInputFormProps) {
  ...
  function handleFileSelected(event: ChangeEvent<HTMLInputElement>) {
    ...
    const selectedFile = files[0] // files sempre sera um array
  ...
  return (
    <form onSubmit={handleUploadVideo} className="space-y-6">
      <label
        className="relative border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center
